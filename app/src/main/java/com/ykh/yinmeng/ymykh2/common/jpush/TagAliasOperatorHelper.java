...
public class TagAliasOperatorHelper {
     ...
     * 增加
     */
    public static final int JPUSH_ACTION_ADD = 1;
    /**
     * 覆盖
     */
    public static final int JPUSH_ACTION_SET = 2;
    /**
     * 删除部分
     */
    public static final int JPUSH_ACTION_DELETE = 3;
    /**
     * 删除所有
     */
    public static final int JPUSH_ACTION_CLEAN = 4;
    /**
     * 查询
     */
    public static final int JPUSH_ACTION_GET = 5;

    public static final int JPUSH_ACTION_CHECK = 6;
    ...
    public void handleAction(Context context, int sequence, TagAliasBean tagAliasBean) {
        ...
        if (tagAliasBean.isAliasAction) {
            switch (tagAliasBean.action) {
                case JPUSH_ACTION_GET:
                    JPushInterface.getAlias(context, sequence);
                    break;
                case JPUSH_ACTION_DELETE:
                    JPushInterface.deleteAlias(context, sequence);
                    break;
                case JPUSH_ACTION_SET:
    ...
    private void showToast(String logs) {
        ToastUtils.showToast(context, logs, Toast.LENGTH_SHORT);
    }
