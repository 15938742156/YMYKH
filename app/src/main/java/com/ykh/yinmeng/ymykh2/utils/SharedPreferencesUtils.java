...
/**
 * [SharedPreferences工具类，提供get和put方法来重写SharedPreferences所提供的方法]
 * @author gengshibiao
 *
 */
...
public class SharedPreferencesUtils {
	...
	private final String tag = SharedPreferencesUtils.class.getSimpleName();
	...
	public static String shareName = "SHARE_DATA";
	...
	public static SharedPreferencesUtils getInstance(Context context,
		...
		if (instance == null) {
			synchronized (SharedPreferencesUtils.class) {
				if (instance == null) {
					instance = new SharedPreferencesUtils(context, shareName);
				}
			}
		}
		return instance;
				...
				for (Method method : methods) {
					...
					for (Field f : fields) {
						...
						if (methodName.toLowerCase().contains(fieldName.toLowerCase())) {
							...
							LogUtils.e(tag, "key: " + fieldName + " value: " + saveValue);
    ...
    public static void saveData(Context context, String username, String s) {
    }
}
