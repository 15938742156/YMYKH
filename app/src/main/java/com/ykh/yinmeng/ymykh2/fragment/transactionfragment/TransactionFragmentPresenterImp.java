...
public class TransactionFragmentPresenterImp<V extends TransactionFragmentMVPView> extends BasePresenter<V> implements TransactionFragmentPresenter<V> {
    ...
    public TransactionFragmentPresenterImp(){
        super();
    }
    ...
    private void getData() {
        ServerApi.<RebateResponse>getrebate("1")
                .subscribeOn(Schedulers.io())
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(@NonNull Disposable disposable) {
                        Log.d("ykh", "收益详情（机器返利和交易返利）");
