...
public class JifenjinduPresenterImp<V extends JifenjinduMVPView> extends BasePresenter<V> implements JifenjinduPresenter<V> {
    ...
    public void onConfirm(String startDate, String endDate) {
        ServerApi.<JifenjinduResponse>jindu(startDate,endDate)
                ...
                .subscribe(new Observer<JifenjinduResponse>() {
                    @Override
                    ...
                    @Override
                    public void onNext(JifenjinduResponse response) {
                        if (response.getCode() == 1) {

                            List<JifenjinduResponse.DataBeanX.DataBean> list = response.getData().getData();
                            if (list != null){
                                itemlist.clear();
