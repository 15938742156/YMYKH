 ...
 * Description：
 */
public class ForgetPresenterImp<V extends ForgetMVPView> extends BasePresenter<V> implements ForgetPresenter<V> {
    ...
    @Override
    public void onToggleModifyBtn(String tel,String password, String yzm) {
        ServerApi.<LzyResponse>findPasswd(tel,password, yzm)
                .subscribeOn(Schedulers.io())
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(@NonNull Disposable disposable) {
                        Log.d("udong", "忘记密码修改密码");
