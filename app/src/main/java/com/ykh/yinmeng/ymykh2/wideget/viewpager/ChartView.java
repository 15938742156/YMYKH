package com.ykh.yinmeng.ymykh2.wideget.viewpager;
...
public class ChartView extends View {
    ...
    private void init() {
        ...
        // x轴刻度值
        if (xLabel == null) {
            xLabel = new String[]{"201806", "201807", "201808", "201809", "201810", "201811", "201812"};
        }
        // 数据点
        if (data == null) {
        ...
        mDataLineColors = new String[]{"#91b2f6", "#85abf8", "#7aa3f7", "#6f9cf7", "#6595f7", "#588cf7", "#3275ff"};
        // 新建画笔
    ...
    private void initParams() {
        ...
        float dataLineStrodeWidth = xScale / 30;      // 数据线条的线宽
