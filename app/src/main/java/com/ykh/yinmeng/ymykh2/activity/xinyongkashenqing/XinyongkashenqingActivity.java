...
public class XinyongkashenqingActivity extends BaseActivity implements XinyongkashenqingMVPView {
    ...
    public XinyongkashenqingPresenter<XinyongkashenqingMVPView> presenter;

    @Override
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        presenter = new XinyongkashenqingPresenterImp<>();
    ...
    public void initListeners() {
        ll_return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                XinyongkashenqingActivity.this.finish();
            }
        });
    }
