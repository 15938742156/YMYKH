...
public class MachineFragmentPresenterImp<V extends MachineFragmentMVPView> extends BasePresenter<V> implements MachineFragmentPresenter<V> {
    ...
    public MachineFragmentPresenterImp(){
        super();
    }
    ...
    private void getData() {
        ServerApi.<RebateResponse>getrebate("2")
