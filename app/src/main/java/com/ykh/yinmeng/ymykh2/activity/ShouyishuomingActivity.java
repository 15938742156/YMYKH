...
public class ShouyishuomingActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initListeners() {
        ...
        webview.loadUrl(Urls.URL_SHOUYI_DETIL);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.ll_return:
                ShouyishuomingActivity.this.finish();
                break;
        }
    }
